...
class Configuration():
	def __init__(self):
		...
		self.TRAIN_CKPT = os.path.join(self.ROOT_DIR,
									   'model/deeplabv3+voc/deeplabv3plus_res101_atrous_VOC2012_epoch46_all.pth')
		...
		self.TEST_CKPT = os.path.join(self.ROOT_DIR,
									  'model/deeplabv3+vocfinetuning/deeplabv3plus_res101_atrous_VOC2012_epoch60_all.pth')
		self.TEST_GPUS = 4
